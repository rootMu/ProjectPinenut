...
public abstract class Hilt_ProfileFragment extends DialogFragment implements GeneratedComponentManager<Object> {
  ...
  public final Object generatedComponent() {
    return UnsafeCasts.<Hilt_ProfileFragment>unsafeCast(this).componentManager().generatedComponent();
  }
  ...
  protected void inject() {
    ((ProfileFragment_GeneratedInjector) UnsafeCasts.<Hilt_ProfileFragment>unsafeCast(this).generatedComponent()).injectProfileFragment(UnsafeCasts.<ProfileFragment>unsafeCast(this));
  }
