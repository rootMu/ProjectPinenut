...
public abstract class Hilt_OnBoardingFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  public final Object generatedComponent() {
    return UnsafeCasts.<Hilt_OnBoardingFragment>unsafeCast(this).componentManager().generatedComponent();
  }
  ...
  protected void inject() {
    ((OnBoardingFragment_GeneratedInjector) UnsafeCasts.<Hilt_OnBoardingFragment>unsafeCast(this).generatedComponent()).injectOnBoardingFragment(UnsafeCasts.<OnBoardingFragment>unsafeCast(this));
  }
